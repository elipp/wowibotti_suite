...
int init_custom_d3d() {
	...
	hr = d->CreateIndexBuffer(4 * sizeof(UINT16), D3DUSAGE_WRITEONLY | D3DUSAGE_DYNAMIC, D3DFMT_INDEX16, D3DPOOL_DEFAULT, &ibuffer, NULL);
	if (FAILED(hr)) {
