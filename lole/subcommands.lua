...
local available_configs = {
    ...
    death_knight_uh =
    class_config_create("death_knight_uh", {}, {"Bone Shield", "Horn of Winter"}, get_class_color("death_knight"), combat_death_knight_uh, {}, ROLES.mana_melee, "MELEE", survive_death_knight_uh),
