...
local available_configs = {
	...
	paladin_prot = 
	class_config_create("paladin_prot", {}, {"Devotion Aura", "Righteous Fury"}, CLASS_COLORS["paladin"], combat_paladin_prot, {"Avenging Wrath"}, ROLES.paladin_tank),
	...
	paladin_retri = 
	class_config_create("paladin_retri", {}, {"Sanctity Aura"}, CLASS_COLORS["paladin"], combat_paladin_retri, {"Avenging Wrath"}, ROLES.caster),
	...
	warrior_prot = 
	class_config_create("warrior_prot", {}, {"Commanding Shout"}, CLASS_COLORS["warrior"], combat_warrior_prot, {"Last Stand"}, ROLES.warrior_tank),
	
	warrior_arms = 
	class_config_create("warrior_arms", {}, {"Battle Shout"}, CLASS_COLORS["warrior"], combat_warrior_arms, {"Death Wish"}, ROLES.warrior_tank),
};
